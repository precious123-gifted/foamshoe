...
<div className="description text-[1.5vw] portrait:text-[3.5vw] portrait:sm:text-[3.5vw] mb-[4vw] ">Descrption goes here for now i dontknow what to say, so i will just leave it like this for now.</div>
